(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        da.init();
        const buttonPlay = document.querySelector(".about-us__play");
        ...
        if (buttonPlay) buttonPlay.addEventListener("click", showVideo);
        let itemNumbers = document.querySelectorAll(".noise-analysis__number");
        let value = 1;
        itemNumbers.forEach((itemNumber => {
            itemNumber.innerHTML = value;
            value += 1;
        }));
        let navItems = document.querySelectorAll(".nav-news__button");
        let navNumber = 1;
        navItems.forEach((navItem => {
            navItem.innerHTML = navNumber;
            navNumber += 1;
        }));
        ...
        for (let i = 0; i < menuLinks.length; i++) if (currentPageUrl.includes(menuLinks[i].href)) {
            let menuItem = document.querySelector("." + menuLinks[i].class + " a[href='" + menuLinks[i].href + "']");
